...
import ImageViewer from './ ImageViewers';
...
return (
  <View style={styles.container}>
    ...
    <View style={styles.footercontainer}>
      <Button icon="image" label="Pick an image" theme="primary" onPress={pickImageAsync} /> 
      <Button icon="check" label="use this photo" theme="secondary" onPress={() => setShowAppOptions(true)} /> 
    </View>
